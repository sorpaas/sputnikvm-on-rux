...
use alloc::{BTreeSet, BTreeMap, btree_map, Vec};
...
pub struct Storage {
    partial: bool,
    address: Address,
    storage: BTreeMap<U256, M256>,
}

impl Into<BTreeMap<U256, M256>> for Storage {
    fn into(self) -> BTreeMap<U256, M256> {
        self.storage
    }
}
...
pub struct AccountState<A: AccountPatch> {
    ...
    premarked_exists: BTreeSet<Address>,
...
impl<A: AccountPatch> AccountState<A> {
    ...
    pub fn used_addresses(&self) -> BTreeSet<Address> {
    ...
    pub fn accounts(&self) -> btree_map::Values<Address, AccountChange> {
